...
int main(){
    ...
    vector<int> case1 = {1,10,3,10,2};
    int boquiteRequired = 3;
    int withFlower = 1;

    cout<<"\n\tNo of days required to make boquite -> "<<test.minDays(case1, boquiteRequired, withFlower);

    case1 = {1,10,3,10,2}; boquiteRequired = 3; withFlower = 2;
    cout<<"\n\tNo of days required to make boquite -> "<<test.minDays(case1, boquiteRequired, withFlower);

    case1 = {7,7,7,7,12,7,7}; boquiteRequired = 2; withFlower = 3;
    cout<<"\n\tNo of days required to make boquite -> "<<test.minDays(case1, boquiteRequired, withFlower);
}