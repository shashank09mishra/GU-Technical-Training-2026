...
async function startSorting() {
    ...
    if (method) {
        document.getElementById("worst-time").innerText = `Worst Time Complexity: ${complexities[method].worst}`;
        document.getElementById("average-time").innerText = `Average Time Complexity: ${complexities[method].average}`;
        document.getElementById("best-time").innerText = `Best Time Complexity: ${complexities[method].best}`;
        document.getElementById("space-complexity").innerText = `Space Complexity: ${complexities[method].space}`;
        document.getElementById("algorithm-description").innerText = complexities[method].desc;
    }
